	...
	return (
		<DrawInfoWrapper>
			<DrawDescription>
				...
				<MainSubTitle>지급된 포인트는 다양한 경품 응모할 수 있어요</MainSubTitle>
			</DrawDescription>
	...
	${(props) => {
		if (props.ranking === 1) {
			return css`
				width: 110px;
				height: 131px;
				background: linear-gradient(180deg, #e7c367 0%, #f2e1b2 50.52%, #c79824 100%);
				border-radius: 6px;
				.circle {
					width: 25px;
					height: 25px;
			...
			return css`
				background: linear-gradient(180deg, #b7b7b7 0%, #f5f5f5 50.52%, #717171 100%);
			`;
		} else if (props.ranking == 3) {
			return css`
				background: linear-gradient(180deg, #b6a67e 0%, #f6eed7 50.52%, #826e3e 100%);
			`;
		}
	}}
`;
